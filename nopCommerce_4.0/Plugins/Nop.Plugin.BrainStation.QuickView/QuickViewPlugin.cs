...
namespace Nop.Plugin.BrainStation.QuickView 
{
    ...
    public class QuickViewPlugin : BasePlugin, IWidgetPlugin, IAdminMenuPlugin
    {
        ...
        public QuickViewPlugin(ISettingService settingService, IWebHelper webHelper)
        {
        ...
        public override void Install()
        {
            var settings = new QuickViewSettings()
            {
                ...
                ButtonContainerName = ".bs-quick-view,.buttons,.overlay-content",
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.BsQuickView.Fields.ButtonContainerName", "Button Container Class (eg: .bs-quick-view, .buttons etc)");
        ...
        public void ManageSiteMap(SiteMapNode rootNode)
        {
            var menuItemBuilder = new SiteMapNode()
            {
                Title = "Bs Quick View",
                Visible = true,
                SystemName = "Mobile Web Api",
                IconClass = "fa-eye"
            };
            //menuItemBuilder.ChildNodes.Add(new SiteMapNode
            //{
            //    Title = "Settings",
            //    Url = "/Admin/BsQuickViewAdmin/BsQuickViewSettings",
            //    SystemName = "Bs Quick View Settings",
            //    Visible = true,
            ...
            {
                Title = "Configure",
                Url = "/Admin/BsQuickViewAdmin/Configure",
                SystemName = "Bs Quick View Configure",
                Visible = true,
                IconClass = "fa-circle-o"
            });
            menuItemBuilder.ChildNodes.Add(new SiteMapNode
            {
                Visible = true,
                Title = "Help",
                Url = "/Admin/BsQuickViewAdmin/BsQuickViewHelp",
                SystemName = "Bs Quick View Help",
                IconClass = "fa-circle-o",
            });
        ...
        {
            viewComponentName= "BsQuickViewPublicInfo";
        }
        ...
        {
            return _webHelper.GetStoreLocation() + "Admin/BsQuickViewAdmin/Configure";
        }
    }
}
